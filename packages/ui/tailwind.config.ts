...
const DARK_MODE = (process.env.DARK_MODE ? process.env.DARK_MODE : 'media') as 'media' | 'class'
if (!['media', 'class'].includes(DARK_MODE)) {
  throw new Error('Invalid dark mode')
}
